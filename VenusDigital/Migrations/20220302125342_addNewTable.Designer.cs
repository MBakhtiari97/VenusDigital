...
namespace VenusDigital.Migrations
{
    ...
    [Migration("20220302125342_addNewTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VenusDigital.Models.Order", b =>
                {
                    ...
                    b.HasIndex("OrderProcessId")
                        .IsUnique()
                        .HasFilter("[OrderProcessId] IS NOT NULL");
            ...
            modelBuilder.Entity("VenusDigital.Models.OrderProcess", b =>
                {
                    b.Property<int>("OrderProcessId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ReferredDescription")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("VenusDigital.Models.Order", b =>
                {
                    b.HasOne("VenusDigital.Models.OrderProcess", "OrderProcess")
                        .WithOne()
                        .HasForeignKey("VenusDigital.Models.Order", "OrderProcessId");
